     ...
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='xuesheng'"  label="教师工号" prop="jiaoshigonghao">
          <el-select v-model="ruleForm.jiaoshigonghao" :disabled="true" placeholder="请选择教师工号">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='xuesheng'"  label="班级" prop="banji">
          <el-select v-model="ruleForm.banji" :disabled="true" placeholder="请选择班级">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='xuesheng'"  label="专业" prop="zhuanye">
          <el-select v-model="ruleForm.zhuanye" :disabled="true" placeholder="请选择专业">
            <el-option
