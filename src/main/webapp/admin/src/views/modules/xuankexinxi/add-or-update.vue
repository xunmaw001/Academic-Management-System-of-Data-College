    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学分" prop="xuefen">
          <el-input v-model="ruleForm.xuefen" 
              placeholder="学分" clearable  :readonly="ro.xuefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学分" prop="xuefen">
              <el-input v-model="ruleForm.xuefen" 
                placeholder="学分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="上课时间" prop="shangkeshijian">
          <el-input v-model="ruleForm.shangkeshijian" 
              placeholder="上课时间" clearable  :readonly="ro.shangkeshijian"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="选课时间" prop="xuankeshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xuankeshijian" label="选课时间" prop="xuankeshijian">
              <el-input v-model="ruleForm.xuankeshijian" 
                placeholder="选课时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xuankexinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xuankexinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
