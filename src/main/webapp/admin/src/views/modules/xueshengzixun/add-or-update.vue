<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="回复状态" prop="huifuzhuangtai">
          <el-select :disabled="ro.huifuzhuangtai" v-model="ruleForm.huifuzhuangtai" placeholder="请选择回复状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="回复状态" prop="huifuzhuangtai">
	      <el-input v-model="ruleForm.huifuzhuangtai"
                placeholder="回复状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="咨询问题" prop="zixunwenti">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zixunwenti" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zixunwenti" label="咨询问题" prop="zixunwenti">
                    <span v-html="ruleForm.zixunwenti"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zixunwenti'){
            this.ruleForm.zixunwenti = obj[o];
	    this.ro.zixunwenti = true;
            continue;
          }
          if(o=='zixunshijian'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='huifuzhuangtai'){
            this.ruleForm.huifuzhuangtai = obj[o];
	    this.ro.huifuzhuangtai = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.zixunwenti = this.ruleForm.zixunwenti.replace(reg,'../../../ssm8r63x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xueshengzixun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xueshengzixunCrossAddOrUpdateFlag = false;
						 this.parent.search();
