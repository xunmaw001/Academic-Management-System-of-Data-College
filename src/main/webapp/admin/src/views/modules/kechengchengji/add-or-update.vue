<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学年" prop="xuenian">
          <el-input v-model="ruleForm.xuenian" 
              placeholder="学年" clearable  :readonly="ro.xuenian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学年" prop="xuenian">
              <el-input v-model="ruleForm.xuenian" 
                placeholder="学年" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考勤成绩" prop="kaoqinchengji">
          <el-input v-model="ruleForm.kaoqinchengji" 
              placeholder="考勤成绩" clearable  :readonly="ro.kaoqinchengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考勤成绩" prop="kaoqinchengji">
              <el-input v-model="ruleForm.kaoqinchengji" 
                placeholder="考勤成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="中期成绩" prop="zhongqichengji">
          <el-input v-model="ruleForm.zhongqichengji" 
              placeholder="中期成绩" clearable  :readonly="ro.zhongqichengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="中期成绩" prop="zhongqichengji">
              <el-input v-model="ruleForm.zhongqichengji" 
                placeholder="中期成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="期末成绩" prop="qimochengji">
          <el-input v-model="ruleForm.qimochengji" 
              placeholder="期末成绩" clearable  :readonly="ro.qimochengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="期末成绩" prop="qimochengji">
              <el-input v-model="ruleForm.qimochengji" 
                placeholder="期末成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否合格" prop="shifouhege">
        ...
        <div v-else>
          <el-form-item class="input" label="是否合格" prop="shifouhege">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='xuenian'){
            this.ruleForm.xuenian = obj[o];
	    this.ro.xuenian = true;
            continue;
          }
          if(o=='xueqi'){
	    ...
	    this.ro.xueqi = true;
          ...
          if(o=='kaoqinchengji'){
            this.ruleForm.kaoqinchengji = obj[o];
	    this.ro.kaoqinchengji = true;
            continue;
          }
          if(o=='zhongqichengji'){
            this.ruleForm.zhongqichengji = obj[o];
	    this.ro.zhongqichengji = true;
            continue;
          }
          if(o=='qimochengji'){
            this.ruleForm.qimochengji = obj[o];
	    this.ro.qimochengji = true;
            continue;
          }
          if(o=='pingyu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `kechengchengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.kechengchengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
