<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学生手机" prop="xueshengshouji">
          <el-input v-model="ruleForm.xueshengshouji" 
              placeholder="学生手机" clearable  :readonly="ro.xueshengshouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学生手机" prop="xueshengshouji">
              <el-input v-model="ruleForm.xueshengshouji" 
                placeholder="学生手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="申请类型" prop="shenqingleixing">
          <el-select :disabled="ro.shenqingleixing" v-model="ruleForm.shenqingleixing" placeholder="请选择申请类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="申请类型" prop="shenqingleixing">
	      <el-input v-model="ruleForm.shenqingleixing"
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shenqingneirong" label="申请内容" prop="shenqingneirong">
                    <span v-html="ruleForm.shenqingneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xueshengshouji : false,
	banji : false,
	zhuanye : false,
	jiaoshigonghao : false,
	shenqingleixing : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='xueshengshouji'){
            this.ruleForm.xueshengshouji = obj[o];
	    this.ro.xueshengshouji = true;
            continue;
          }
          if(o=='banji'){
	    ...
	    this.ro.jiaoshigonghao = true;
          ...
          if(o=='shenqingleixing'){
            this.ruleForm.shenqingleixing = obj[o];
	    this.ro.shenqingleixing = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.xueshengshouji!=''&&json.xueshengshouji){
                this.ruleForm.xueshengshouji = json.xueshengshouji
	    		this.ro.xueshengshouji = true;
		}
	...
	this.ruleForm.shenqingneirong = this.ruleForm.shenqingneirong.replace(reg,'../../../ssm8r63x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
